/* This code comes from https://github.com/tavis-software/UriTemplates/ 
 * The author apparently has no idea what the license is. */
            ...
            private static string Encode(string p, bool allowReserved)
            {
                ...
                foreach (char c in p)
                {
                    ...
                    else 
                    {
                        ...
                        result.Append(String.Format(CultureInfo.InvariantCulture, "%{0:X2}", value));
                    }
                }
